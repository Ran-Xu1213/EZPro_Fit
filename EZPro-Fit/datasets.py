...
from EZPro_Fit.utils.codon_const import (
    unk_codon,
    codon_order,
    codon_to_res,
    unk_codon_index,
)
from EZPro_Fit.utils.data_utils import parse_mmcif, parse_pdb
from EZPro_Fit.utils.flow_pmpnn import get_weird_pmpnn_stuff
...
def _resolve_pdb_path(original_path, afdb_dir):
    ...
    raise FileNotFoundError(f"PDB file not found. Tried: {candidates}")
