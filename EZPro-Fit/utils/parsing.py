...
def parse_train_args():
    ...
    group.add_argument('--afdb_dir', type=str, default="/data/xr/CodonMPNN/data/pdb_structures_from_tsv/")

    group.add_argument('--data_csv', type=str, default="data/train.csv")
